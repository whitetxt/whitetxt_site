...
<head>
    ...
    <!-- Facebook Meta Tags -->
    <meta property="og:url" content="https://whitetxt.dev/clips/view_clip.php?file=<?= $fn ?>">
    <meta property="og:title" content="_whitetxt's clip zone - <?= $f->readname ?>">
    <meta property=" og:type" content="video.other">
    <meta property="og:image" content="https://whitetxt.dev/clips/get_thumb.php?file=<?= $fn ?>">
    <meta property="og:image:type" content="image/jpeg">
    <meta property="og:image:width" content="1920">
    <meta property="og:image:height" content="1080">
    <meta property="og:video" content="https://whitetxt.dev/clips/get_clip.php?file=<?= $fn ?>">
    <meta property="og:video:url" content="https://whitetxt.dev/clips/get_clip.php?file=<?= $fn ?>">
    <meta property="og:video:type" content="video/mp4">
    ...
    <!-- Twitter Meta Tags -->
    <meta name="twitter:card" content="player">
    <meta property="twitter:url" content="https://whitetxt.dev/clips/view_clip.php?file=<?= $fn ?>">
    ...
    <meta name="twitter:description" content="_whitetxt's place to upload and share epic gamer moments!
        Watch `<?= $f->readname ?>` on here now!">
    <meta name="twitter:image" content="https://whitetxt.dev/clips/get_thumb.php?file=<?= $fn ?>">
    <meta name="twitter:player:width" content="1920">
    <meta name="twitter:player:height" content="1080">
    <meta name="twitter:player" content="https://whitetxt.dev/clips/get_clip.php?file=<?= $fn ?>">
    <?php } ?>
...
<body class="h-screen flex flex-col items-center">
    ...
    <div class="card bg-base-100 w-3/4 shadow-xl mx-auto">
        ...
        if ($file !== null) { ?>
        <figure>
            <video controls src="get_clip.php?file=<?= $fn ?>"></video>
        </figure>
        <div class="card-body text-lg">
            ...
            <div class="card-actions justify-end">
                <a class="btn btn-primary" href="download_file.php?file=<?= $fn ?>">Download</a>
